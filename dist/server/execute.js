import { asNumber, asString, buildInvocationEnvForLogs, buildPaperclipEnv, joinPromptSections, parseObject, renderPaperclipWakePrompt, renderTemplate, stringifyPaperclipWakePayload, } from "@paperclipai/adapter-utils/server-utils";
...
export async function execute(ctx) {
    ...
    const promptTemplate = asString(config.promptTemplate, "You are agent {{agent.name}} ({{agent.id}}). Continue your Paperclip work for company {{agent.companyId}}.");
